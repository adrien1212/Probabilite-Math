...
public class LoiDiscrete {
    ...
    /**
     * @param ensembleValeur les valeurs saisies par l'utilisateurs
     * @param probabiliteValeur probabilité associées aux valeurs saisies
     */
    public LoiDiscrete(double[] ensembleValeur, double[] probabiliteValeur) {
        ...
        if(!estValeurProbabiliteCorrecte(probabiliteValeur)) {
     ...
     * @param probabiliteASommer l'ensemble les probabilité saisies
     ...
     */
    private static boolean estValeurProbabiliteCorrecte(double[] probabiliteAVerifier) {
    ...
    /**
     * Vérifie que les variables aléatoires passé en paramètre ne contiennent
     * pas de doublon
     * @param ensembleValeur tableau contenant les variables aléatoires
     * @return true si un doublon est trouvé
     *         false sinon
     */
    private static boolean estAvecDoublons(double[] ensembleValeur) {
    ...
    public double[] getEnsembleValeur() {
        return ensembleValeur;
    }
    ...
    public double[] simuler(int nbSimulation) {
         ...
         * du fichier CSV
         */
        this.sauvegarderTempo(resultat);
    ...
    /**
     * Sauvegarde temporairement les résultat
     ...
     * @param fichierDestination fichier où la sauvegarde à lieu 
     */
